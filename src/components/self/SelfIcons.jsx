export function SelfIcon({ name }) {
  const icons = {
    ...
    calories: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 3c-1.2 2.4-3.6 4.2-3.6 7.2 0 2 1.6 3.6 3.6 3.6s3.6-1.6 3.6-3.6C15.6 7.2 13.2 5.4 12 3z" />
        <path d="M8.5 14.5c-1.2 1.4-2 3-2 4.8 0 3.1 2.5 5.7 5.5 5.7s5.5-2.6 5.5-5.7c0-1.8-.8-3.4-2-4.8" />
      </svg>
    ),
    weight: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 3v3" />
        <path d="M8.5 6h7" />
        <path d="M6.5 9.5a5.5 5.5 0 0 1 11 0c0 4.2-2.5 7.5-5.5 11.5C9 17 6.5 13.7 6.5 9.5z" />
    ...
    walk: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M9 22l1.5-5.5L8 12l2.5-3 2 6.5L15 22" />
        <path d="M16 8.5l2.5 2.5L19 16" />
      </svg>
    ),
    checkCircle: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
