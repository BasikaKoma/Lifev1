export const APP_MODEL = {
  ...
  notAProject: [
    ...
    'A meal plan, grocery list, pantry, or nutrition profile (belongs in Nutrition)',
  ],
  ...
  nutritionRule: 'Nutrition is a first-class app layer (sidebar, under Personal Brand). Never create a project named Nutrition. Do not invent medical calorie prescriptions; use the user\'s targets or labelled suggestions.',
